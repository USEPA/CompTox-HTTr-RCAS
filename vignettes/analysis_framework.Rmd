...
struct_ms <- c(
  ...
  "1-4-diaminoanthraquinone", "1-naphthol", "2-ethylanthraquinone", "1-4-benzoquinone",
...
ggsave(
  paste0(dir_home, "output/Fig5_alt.png"), plots_candidate_struct,
  width = 1600, height = 1600, units = "px", scale = 1.6, bg = "white"
)
