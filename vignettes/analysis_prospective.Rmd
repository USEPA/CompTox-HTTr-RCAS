...
plot_potency <- combined_prosp %>%
  ...
  geom_point(size = 2) +
  geom_text_repel(min.segment.length = 0, size = 2.4, max.overlaps = 5, box.padding = 0.28) +
...
plot_all <- cowplot::plot_grid(
  ...
  labels = c("A", ""), ncol = 2, label_fontfamily = "Helvetica"
)
ggsave(
  paste0(dir_home, "output/Fig6.png"), plot_all,
  width = 1400, height = 960, units = "px", scale = 2, bg = "white"
)
```
