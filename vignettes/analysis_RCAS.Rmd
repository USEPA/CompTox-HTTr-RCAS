...
plot_overlap <- ggplot(composite_overlap, aes(x = rcas_list)) +
  ...
  geom_text(stat = "count", aes(label = after_stat(count)), family = "Helvetica", vjust = -1) +
...
tiff(
  filename = paste0(dir_home, "output/Fig1.tiff"), compression = "lzw",
